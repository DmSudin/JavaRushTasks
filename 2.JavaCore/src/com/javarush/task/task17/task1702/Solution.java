...
public class Solution {
    ...
    public static void main(String[] args) throws InterruptedException {
        StringBuffer expectedResult = new StringBuffer();               // expectresult = "999 998 ... 0"
        for (int i = 1000 - 1; i >= 0; i--) {
            expectedResult.append(i).append(" ");
        }

        initThreads();                                                  // all threads start then all join

        StringBuffer result = new StringBuffer();                   // str result = 0 1 2  .. 999
